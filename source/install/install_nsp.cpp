...
namespace tin::install::nsp
{
    ...
    void NSPInstallTask::GetBuffer(const NcmContentId& contentId, void * out_header, size_t offset, size_t size)
    {
        std::string ncaName = tin::util::GetNcaIdString(contentId);
        ...
        ncaFile.Read(offset, out_header, size);
    }
